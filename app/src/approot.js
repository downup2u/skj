...
const CoApp = (props) => {
    ...
    return (
        <Switch>
            ...
            <CustomRoute path="/addnewdevice3/:deviceid" component={requireAuthentication(AddNewDevice3)}/>
            ...
            <CustomRoute path="/logisticsinfo" component={requireAuthentication(LogisticsInfo)}/>
            ...
            <CustomRoute path="/shareprodinfo/:id" component={ShareShoppingProinfo}/>
